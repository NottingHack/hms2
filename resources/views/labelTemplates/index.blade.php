@extends('layouts.app') @section('pageTitle', 'Label Templates') @section('content')
<div class="container">
    ...
    <table class="table table-bordered table-hover table-responsive">
        ...
        <tr>
            ...
            </a> @endcan @if (SiteVisitor::inTheSpace()) @can('labelTemplate.print')
                <a class="btn btn-primary btn-sm btn-sm-spacing" href="{{ route('labels.showPrint', $labelTemplate->getTemplateName()) }}">Print</a> @endcan @endif
            </td>
        </tr>
        @endforeach
    </table>
