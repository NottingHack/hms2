@extends('layouts.app') @section('pageTitle', 'Log In') @section('content')
...
<div class="container">
    ...
    <div class="card-body-padding card-container text-center">
        ...
        <form class="form-signin" role="form" method="POST" action="{{ url('/login') }}">
            ...
            <input id="login" type="text" name="login" value="{{ old('login') }}" class="form-control" placeholder="Email address or Username" required autofocus> @if ($errors->has('login'))
            <p class="help-text">
