...
class Version20170512233938_add_emails_table extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE email_users (email_id INT UNSIGNED NOT NULL, user_id INT UNSIGNED NOT NULL, INDEX IDX_E1F35DCBA832C1C9 (email_id), INDEX IDX_E1F35DCBA76ED395 (user_id), PRIMARY KEY(email_id, user_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
