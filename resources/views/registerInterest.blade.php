...
<div class="container">
        ...
        <div class="card-body-padding card-container">
            
            <svg version="1.1" x="0px" y="0px" width="75" height="75" viewBox="0 0 220 220" enable-background="new 0 0 223.489 220.489" id="logo" class="profile-img-card">
            ...
            <p id="profile-name" class="profile-name-card">Register Interest</p>
            
            <br>
            
            <form class="form-signin" role="form" method="POST" action="{{ route('registerInterest') }}">
  {{ csrf_field() }}
      ...
      @endif
                ...
                <button class="btn btn-lg btn-primary btn-block btn-signin" type="submit">Register Interest</button>
            </form><!-- /form -->
