  ...
  <header>
    <div class="row expanded header">
      <div class="columns shrink">
        <!-- Hackspace logo SVG -->
        <svg version="1.1" x="0px" y="0px" width="75" height="75" viewBox="0 0 220 220" enable-background="new 0 0 223.489 220.489">
          <path id="logo"
      ...
      <div class="columns">
        @hasSection('pageTitle')
          <h1 class="tiny-header">Nottingham Hackspace</h1>
