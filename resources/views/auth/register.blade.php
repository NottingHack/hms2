...
<div class="container">
  <div class="card-body-padding">
    ...
    <p id="profile-name" class="profile-name-card">Create account</p>
    ...
    <form class="form-signin" id="register-form" role="form" method="POST" action="{{ url('/register') }}">
      ...
      <input placeholder="Forename" class="form-control" id="firstname" type="text" name="firstname" value="{{ old('firstname') }}" required autofocus>
      ...
      <input placeholder="Surname" class="form-control" id="lastname" type="text" name="lastname" value="{{ old('lastname') }}" required>
      ...
      <input placeholder="Username" class="form-control" id="username" type="text" name="username" value="{{ old('username') }}" required>
      ...
      <input placeholder="Email Address" class="form-control" id="email" type="email" name="email" value="{{ old('email', $email) }}" required>
      @if ($errors->has('email'))
      <p class="help-text">
      ...
      <input placeholder="Address 1" class="form-control" id="address1" type="text" name="address1" value="{{ old('address1') }}" required autocomplete="address-line1">
      ...
      <input placeholder="Address 2" class="form-control" id="address2" type="text" name="address2" value="{{ old('address2') }}" autocomplete="address-line2">
      ...
      <input placeholder="Address 3" class="form-control" id="address3" type="text" name="address3" value="{{ old('address3') }}" autocomplete="address-line3">
      ...
      <input placeholder="County" class="form-control" id="addressCounty" type="text" name="addressCounty" value="{{ old('addressCounty') }}" required autocomplete="region">
      ...
      <input placeholder="Postcode" class="form-control" id="addressPostcode" type="text" name="addressPostcode" value="{{ old('addressPostcode') }}" required autocomplete="postal-code">
      ...
      <input placeholder="Contact Number" class="form-control" id="telephone" type="text" name="contactNumber" value="{{ old('contactNumber') }}" required autocomplete="tel">
      ...
      <input placeholder="yyyy-mm-dd" class="form-control" id="dateOfBirth" type="date" name="dateOfBirth" value="{{ old('dateOfBirth') }}">
