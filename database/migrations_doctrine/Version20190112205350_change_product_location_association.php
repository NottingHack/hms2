...
class Version20190112205350_change_product_location_association extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_vending_location (vending_location_id INT UNSIGNED NOT NULL, product_id INT UNSIGNED NOT NULL, INDEX IDX_44048F6C035A559 (vending_location_id), INDEX IDX_44048F64584665A (product_id), PRIMARY KEY(vending_location_id, product_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
