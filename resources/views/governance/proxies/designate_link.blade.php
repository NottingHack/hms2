...
<div class="container">
  ...
  <p>
    ...
    <ol>
      ...
      <li>Email, Slack or SMS them the link below. Hint click (<button class="btn btn-light btn-sm" onclick="copyToClipboard('#designate-link')"><i class="far fa-copy "></i></button>) to copy it to your clipboard.</li>
  ...
  <span class="align-middle">
    ...
    <button class="btn btn-light btn-sm" onclick="copyToClipboard('#designate-link')"><i class="far fa-copy "></i></button>
  </span>
  </p>
  <p>
