...
class BannedMemberReinstated extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Banned Member Reinstated')
            ->greeting('Hello ' . $notifiable->getDisplayName())
            ->line($this->user->getFullname() . ' has just been reinstated from their ban by  '
