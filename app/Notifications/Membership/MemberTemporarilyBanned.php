...
class MemberTemporarilyBanned extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Member Temporarily Banned')
            ->greeting('Hello ' . $notifiable->getDisplayName())
            ->line($this->user->getFullname() . ' has just been temporarily banned by '
